    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Apply(string Message)
        {
            ...
            if (check.Count < 1)
            {
                ...
                db.SaveChanges();
                ViewBag.Result = "/Added with success!";
            }
            else
            {
                ViewBag.Result = "!/Sorry, you previously applied to the same job!";
            }
        ...
        public ActionResult GetAllAppliedJobs()
        {
            var app = db.ApplyForJobs.ToList();
            return View(app);
        }
